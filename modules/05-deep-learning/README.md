...
> [Ch9 — Build micrograd II: backward through a graph](ch09-micrograd-backward.qmd) ·
> [Ch10 — An MLP from scratch](ch10-mlp-from-scratch.qmd) ·
> [Ch11 — GPUs & your first Colab notebook](ch11-gpus-first-colab.qmd)
